...
Test your implementation using the Bitcoin Number Decoder Simulator above. Try various inputs to ensure your decoder handles both positive and negative numbers correctly.
