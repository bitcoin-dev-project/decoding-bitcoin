...
The project source code exists on Github, at the following URL: https://github.com/jrakibi/bitcoin-stack
...
<div className="relative w-full h-screen mb-32 overflow-hidden">
    <Image
