    ...
    <div className="min-h-screen p-6 bg-[#1e1e1e]">
      <div className="max-w-3xl mx-auto">
        <div className="flex justify-between items-center mb-6">
          ...
          <button
            onClick={runTests}
            className="bg-[#f1760f] hover:bg-[#e56c0d] text-[#d4d4d4] font-bold py-2 px-4 rounded flex items-center"
          >
        ...
        {isLoading ? (
          <div className="flex justify-center items-center h-64">
            <div className="animate-spin rounded-full h-8 w-8 border-t-2 border-b-2 border-[#f1760f]"></div>
          </div>
        ) : (
          <>
            <div className="mb-6 p-4 bg-[#252526] border border-[#4c4d52] rounded-lg">
              <h2 className="font-bold text-[#d4d4d4]">Test Summary</h2>
              <p className="text-[#d4d4d4] mt-2">
                Total Tests: {results.length} |
                <span className="text-[#689f38] ml-2">Passed: {passCount}</span> |
                <span className="text-[#d32f2f] ml-2">Failed: {failCount}</span>
              </p>
            </div>
