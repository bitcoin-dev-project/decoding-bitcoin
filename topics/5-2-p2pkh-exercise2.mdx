...
<div className="max-w-3xl mx-auto rounded-md m-4 mr-3 ml-3 p-4 bg-white shadow-md">
<h1 className="text-3xl font-bold mb-6 text-center text-gray-800">P2PKH ScriptPubKey Decoder</h1>
      ...
      <div className="mb-6">
        <div className="flex">
          <input
            ...
            className="flex-grow p-3 border border-gray-300 rounded-l-md shadow-sm focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500"
          />
          <button
      ...
      <div className="bg-gray-100 p-4 rounded-md shadow">
        <h3 className="font-bold text-lg mb-2 text-gray-800">Test Cases:</h3>
        <div className="space-y-2">
          {testCases.map((testCase, index) => (
            <details key={index} className="border border-gray-300 rounded-md">
              <summary className="cursor-pointer p-2 bg-gray-200 hover:bg-gray-300 text-gray-700">
                {testCase.type}
              </summary>
              <div className="p-2 text-sm bg-white text-gray-700">
